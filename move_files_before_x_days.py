...
#usage = 'python move_files_before_x_days.py -src E:\Giang_Day\Python_Can_Ban\Bai_tap\Test_1 -dst E:\Giang_Day\Python_Can_Ban\Bai_tap\Test_2'
usage = 'python move_files_before_x_days.py -src [SRC] -dst [DST] -days [DAYS]'
